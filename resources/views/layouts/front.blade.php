...
<body>
    ...
    <header>
        <div class="header-bottom pt-40 pb-30 clearfix">
            <div class="header-bottom-wrapper pr-200 pl-200">
                <div class="logo-3">
                    <a href="{{ route('home') }}">
                        <img src="/nat.png" alt="" class="pl-20" >
                    </a>
                </div>
                <div class="categories-search-wrapper">
                    <div class="trace-cart-wrapper">
                        @auth
                            ...
                            <div class="categories-cart same-style">
                                <div class="same-style-icon">
                                    <a href="#"><i class="pe-7s-cash"></i></a>
                                </div>
                                <div class="same-style-text">
                                    <a href="/token">View Orders
                                    </a>
                                </div>
                            </div>
                        @endauth
    ...
    @yield('product-category-1')
    @yield('product-catalog')
    @yield('checkout-details')
    @yield('token')
    @yield('login')
    <footer  class="footer-area">
        {{-- <footer style="background: lightblue url("nat.png") no-repeat fixed center;()" class="footer-area"> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-widget-content-3">
                                <ul>
                                    <li><a href="/register">Login Here</a></li>
                                    <li><a href="/cart">Cart</a></li>
                                    <li><a href="/token"> Order History</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <div class="footer-widget widget-right mb-40">
                            <h3 class="footer-widget-title-3">BIG YARD</h3>
                            <div class="footer-widget-content-3">
                                <img src="/nat.png" alt="">
